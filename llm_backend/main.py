...
# 创建 FastAPI 应用实例
app = FastAPI(title="huangqicheng REST API")
...
async def upload_file(
    ...
    try:
        ...
        # 4. 处理文件索引 - 暂时注释掉，避免openai版本冲突问题
        # indexing_service = IndexingService()
        # index_result = await indexing_service.process_file(file_info)
        index_result = {"status": "disabled", "message": "Indexing service temporarily disabled"}
