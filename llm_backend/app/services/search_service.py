    ...
    async def generate_stream(
        ...
        try:
            ...
            if choice.finish_reason == "tool_calls":
                ...
                if tool_calls:
                    ...
                    try:
                        ...
                        if search_results:
                            ...
                            search_start_data = {'type': 'search_start'}
                ...
                direct_answer_data = {'type': 'direct_answer'}
                yield f"data: {json.dumps(direct_answer_data, ensure_ascii=False)}\n\n"
                ...
                async for chunk in stream_response:
                    if chunk.choices and chunk.choices[0].delta.content:
                        ...
                        # 包装直接回答的内容
                        content_data = {'type': 'direct_content', 'content': content}
