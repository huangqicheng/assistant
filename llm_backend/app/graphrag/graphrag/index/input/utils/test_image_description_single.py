...
def generate_single_image_description(
    image_path, 
    output_file=None,
    api_key="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",
    model="gpt-4o",
    max_retries=3,
    retry_delay=2,
    max_tokens=300,
